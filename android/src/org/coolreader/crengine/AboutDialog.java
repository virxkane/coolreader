...
public class AboutDialog extends BaseDialog implements TabContentFactory {
	...
	public AboutDialog( CoolReader activity)
	{
		...
		if (isFork) {
			((TextView) mAppTab.findViewById(R.id.version)).setText("Cool Reader (virxkane mod) " + mCoolReader.getVersion());
			((TextView) mAppTab.findViewById(R.id.www1)).setText("https://github.com/virxkane/coolreader");
			//LinearLayout layout1 = (LinearLayout)mAppTab.findViewById(R.id.layout1);
			//View wwwView = (View)mAppTab.findViewById(R.id.www);
			//wwwView.setVisibility(View.INVISIBLE);
			//View sfView = (View)mAppTab.findViewById(R.id.sourceforge);
			//sfView.setVisibility(View.INVISIBLE);
			//layout1.removeView(wwwView);
			//layout1.removeView(sfView);
		} else {
